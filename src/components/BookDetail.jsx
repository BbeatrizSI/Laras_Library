        ...
        <div className="overflow-y-auto p-6 pt-2">
          ...
          <div className="grid grid-cols-3 gap-4 py-4 border-y border-gray-100 mb-6">
            <div className="text-center">
              <span className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest">Año</span>
              <p className="text-sm font-bold text-gray-800">{libro.año}</p>
            </div>
            <div className="text-center border-x border-gray-100">
              <span className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest">Páginas</span>
              <p className="text-sm font-bold text-gray-800">{libro.paginas}</p>
            </div>
            <div className="text-center">
              <span className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest">Género</span>
              <p className="text-[11px] font-bold text-gray-800 leading-tight uppercase">{libro.genero}</p>
            </div>
          </div>

          {/* Sinopsis Larga */}
          <div className="mb-8">
            <h3 className="text-sm font-bold text-gray-900 uppercase mb-3 tracking-wider">Sinopsis</h3>
          ...
          <div className="flex flex-col gap-3 pb-4">
            <a 
              ...
              target="_blank" 
              rel="noreferrer" 
              className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-2xl font-bold text-center shadow-lg shadow-blue-200 transition-all active:scale-[0.98]"
            >
              Leer Libro en Drive
            </a>
            <button 
